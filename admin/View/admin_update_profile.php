...
<body>
    ...
    <section class="updateInfo-form">
        ...
        <form onsubmit="return validateForm()" action="../Controllers/adminUpdateProfileCTRL.php" method="post"
      ...
      ?>
            ...
            <input type="text" name="fullname" maxlength="50" placeholder="<?= $fetch_profile['fullname']; ?>"
                class="box">
            <p class="placeholder">Username</p>
            <input type="text" id="username" name="username" maxlength="50"
                placeholder="<?= $fetch_profile['username']; ?>" class="box">
            <span class="error" id="usernameError"></span>
            <p class="placeholder">Email của bạn</p>
            <input type="email" id="email" name="email" maxlength="50" placeholder="<?= $fetch_profile['email']; ?>"
                class="box">
            <span class="error" id="emailError"></span>
            <p class="placeholder">Số điện thoại</p>
            <input type="text" id="phoneNumber" name="phonenumber" maxlength="50"
                placeholder="<?= $fetch_profile['phonenumber']; ?>" class="box">
            ...
            <input type="password" id="password" name="newpass" maxlength="50" placeholder="Nhập mật khẩu mới"
                class="box">
            ...
            <input type="submit" value="Xóa ảnh đại diện" name="delete_image" class="delete-btn"
