        ...
        <div class="information-detail" data-aos="fade-left" data-aos-delay="600">
            ...
            <form action="../Controllers/cartController.php" method="post">
                <div class="quantity-input">
                    ...
                    <input type="number" min="1" name="product_quantity" value="1" readonly class="cart-quantity-input"
                        id="product-quantity">
    ...
    <section class="descriptionBook" data-aos="zoom-in-up" data-aos-delay="300">
        <div class="heading combo">
            ...
            <div class="description">
                <?php echo nl2br($product['description_detail']) ?>
            </div>
            <div class="book">
                <?php
                ...
                ?>
                <div class="description">
                    <?php echo nl2br($product['description_1']) ?>
                </div>
                <?php
            ...
            <div class="book">
                ...
                ?>
                <div class="description">
                    <?php echo nl2br($product['description_2']) ?>
                </div>
                <?php
            ...
            <div class="book">
                ...
                ?>
                <div class="description">
                    <?php echo nl2br($product['description_3']) ?>
                </div>
                <?php
                        ...
                        ; ?>>
                            ...
                            while ($fetch_user = mysqli_fetch_assoc($select_user)) {
                                ...
                                <div class="user">
                                    ...
                                    <?php } else { ?>
                                        <h3>
                                            <?= substr($fetch_user['username'], 0, 1); ?>
                                        </h3>
                                    <?php }
                                    ; ?>
                                    <div>
